...
#define SI_XTAL_FREQ  (25000000UL+3050UL)  // Replace with measured crystal frequency of XTAL for CL = 10pF (default)
...
//	SI_SETFREQ(0, 10000000);
//	SI_SETPHASE(0, 1);        // 90 degree phase diff between 0 and 1
}
